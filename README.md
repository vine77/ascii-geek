...
4. Name the Lambda Function "asciiGeek".
...
2. Set "ASCII Geek" as the skill name and "ASCII Geek" as the invocation name, this is what is used to activate your skill. For example you would say: "Alexa, Ask ASCII Geek for an ASCII fact."
